    ...
    <div class="page-direction-main-container">
        <div class="page-direction-container flex justify-between items-center tracking-wider">
            ...
            <div class="page-direction-right uppercase">
                <a href="./index.html">home</a> / <a href="./product_page.html" class="font-semibold">product</a>
            </div>
        </div>
    </div>
    <div class="product-page-body-container">
        <div class="product-page-body flex justify-between items-start">
            <div class="product-page-left-body">
                <div class="product-page-left-main-img-container w-full">
                    <div class="product-page-left-main-img w-full h-full">
                        <img src="./assets/img/2.jpg" class="w-full h-full" alt="2">
                    </div>
                </div>
                <div class="product-page-left-bottom-show-img-main-container w-full">
                    <div class="product-page-left-bottom-show-img-container flex">
                        <div class="active product-page-left-bottom-show-img">
                            <img src="./assets/img/27.jpg" class="w-full" alt="27">
                        </div>
                        <div class="product-page-left-bottom-show-img">
                            <img src="./assets/img/27.jpg" class="w-full" alt="27">
                        </div>
                        <div class="product-page-left-bottom-show-img">
                            <img src="./assets/img/27.jpg" class="w-full" alt="27">
                ...
                <script>
                    let getproductPageLeftBottomShowImgContainer = document.querySelector(".product-page-left-bottom-show-img-container");
                    let getproductPageLeftBottomShowImg= document.querySelector(".product-page-left-bottom-show-img");
                    let getproductPageLeftBottomShowImgs = document.querySelectorAll(".product-page-left-bottom-show-img");
                    
                    getproductPageLeftBottomShowImgContainer.style.width = `${getproductPageLeftBottomShowImg.offsetWidth * getproductPageLeftBottomShowImgs.length + 1000}px`;
                    console.log(getproductPageLeftBottomShowImgContainer.offsetWidth);

                    function productLeftActive (){
                        getproductPageLeftBottomShowImgs.forEach((items)=>{
                            items.classList.remove("active");
                        })
                        this.classList.add("active")
                    }
                    getproductPageLeftBottomShowImgs.forEach((items)=>{
                        items.addEventListener("click",productLeftActive)
                    })
                </script>
            </div>
            <div class="product-page-right-body">
                <form action="">
                    ...
                    <div class="product-title-container product-right-margin-adjust">
                        <h1 class="uppercase font-semibold">WOMEN PINK SHIRT</h1>
                    </div>
                    ...
                    <div class="product-price-container product-right-margin-adjust">
                        <span class="">$32.96</span><span class="line-through mx-2">$459.00</span><span>55% off</span>
                    </div>
                    ...
                    <div class="size-select-container product-right-margin-adjust flex justify-between">
                        <div class="select-size">
                            ...
                            <ul class="flex m-0 p-0">
                                <li class="size-list-1 sizeListActive grid place-items-center relative">s</li>
                                <li class="size-list-2 grid place-items-center mx-2 relative">m</li>
                                <li class="size-list-3 grid place-items-center mx-2 relative">l</li>
                                <li class="size-list-4 grid place-items-center relative">xl</li>
                            </ul>
                            <script>
                    ...
                    <div class="quantity-container product-right-margin-adjust">
                        ...
                        <div class="quantiy-box">
                            <div class="btn-group border rounded-0">
                                ...
                                <input type="number" name="" id=""  class="apperence-none rounded-0 quentity-count" value= "1">
    ...
    <div class="latest-drop-body grid place-items-center ">
        <div class="latest-drop-show-items-container flex justify-center items-center">
            <div class="latest-drop-show-items">
                <a href="./product_page.html" class="w-full product-photo-container">
